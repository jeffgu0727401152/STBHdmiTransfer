...
#define MASK_MIPS16 (1 << 17)
#define MASK_MIPS3D (1 << 18)
#define MASK_LLSC (1 << 19)
#define MASK_LONG64 (1 << 20)
#define MASK_MEMCPY (1 << 21)
#define MASK_PAIRED_SINGLE_FLOAT (1 << 22)
#define MASK_RELAX_PIC_CALLS (1 << 23)
#define MASK_SMARTMIPS (1 << 24)
...
enum opt_code
{
  ...
  OPT_Wpragmas = 315,                        /* -Wpragmas */
  OPT_Wproperty_assign_default = 316,        /* -Wproperty-assign-default */
  OPT_Wprotocol = 317,                       /* -Wprotocol */
  OPT_Wpsabi = 318,                          /* -Wpsabi */
  OPT_Wraw = 319,                            /* -Wraw */
  OPT_Wreal_q_constant = 320,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 321,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 322,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 323,                /* -Wredundant-decls */
  OPT_Wredundant_modifiers = 324,            /* -Wredundant-modifiers */
  OPT_Wreorder = 325,                        /* -Wreorder */
  OPT_Wreturn_local_addr = 326,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 327,                    /* -Wreturn-type */
  OPT_Wselector = 328,                       /* -Wselector */
  OPT_Wsequence_point = 329,                 /* -Wsequence-point */
  OPT_Wserial = 330,                         /* -Wserial */
  OPT_Wshadow = 331,                         /* -Wshadow */
  OPT_Wsign_compare = 332,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 333,                /* -Wsign-conversion */
  OPT_Wsign_promo = 334,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 335,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 336,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 337,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 338,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 339,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 340,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 341,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 342,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 343,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 344,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 345,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 346,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 347,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 348,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 349,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 350,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 351,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 352,                       /* -Wsuppress */
  OPT_Wsurprising = 353,                     /* -Wsurprising */
  OPT_Wswitch = 354,                         /* -Wswitch */
  OPT_Wswitch_default = 355,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 356,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 357,                      /* -Wsync-nand */
  OPT_Wsynth = 358,                          /* -Wsynth */
  OPT_Wsynthetic_access = 359,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 360,                 /* -Wsystem-headers */
  OPT_Wtabs = 361,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 362,                /* -Wtarget-lifetime */
  OPT_Wtasks = 363,                          /* -Wtasks */
  OPT_Wtraditional = 364,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 365,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 366,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 367,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 368,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 369,                    /* -Wtype-limits */
  OPT_Wuncheck = 370,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 371,            /* -Wundeclared-selector */
  OPT_Wundef = 372,                          /* -Wundef */
  OPT_Wunderflow = 373,                      /* -Wunderflow */
  OPT_Wuninitialized = 374,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 375,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 376,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 377,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 378, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 379,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 380,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 381,                         /* -Wunused */
  OPT_Wunused_argument = 382,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 383,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 384,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 385,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 386,                /* -Wunused-function */
  OPT_Wunused_import = 387,                  /* -Wunused-import */
  OPT_Wunused_label = 388,                   /* -Wunused-label */
  OPT_Wunused_local = 389,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 390,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 391,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 392,               /* -Wunused-parameter */
  OPT_Wunused_private = 393,                 /* -Wunused-private */
  OPT_Wunused_result = 394,                  /* -Wunused-result */
  OPT_Wunused_thrown = 395,                  /* -Wunused-thrown */
  OPT_Wunused_value = 396,                   /* -Wunused-value */
  OPT_Wunused_variable = 397,                /* -Wunused-variable */
  OPT_Wuseless_cast = 398,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 399,             /* -Wuseless-type-check */
  OPT_Wvarargs = 400,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 401,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 402,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 403,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 404,            /* -Wvirtual-move-assign */
  OPT_Wvla = 405,                            /* -Wvla */
  OPT_Wvolatile_register_var = 406,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 407,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 408,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 409,  /* -Wzero-as-null-pointer-constant */
  OPT_Xassembler = 410,                      /* -Xassembler */
  OPT_Xlinker = 411,                         /* -Xlinker */
  OPT_Xpreprocessor = 412,                   /* -Xpreprocessor */
  OPT_Z = 413,                               /* -Z */
  OPT_ansi = 414,                            /* -ansi */
  OPT_aux_info = 415,                        /* -aux-info */
  /* OPT_aux_info_ = 416, */                 /* -aux-info= */
  OPT_auxbase = 417,                         /* -auxbase */
  OPT_auxbase_strip = 418,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 419, */             /* -bootclasspath */
  OPT_c = 420,                               /* -c */
  /* OPT_classpath = 421, */                 /* -classpath */
  OPT_coverage = 422,                        /* -coverage */
  OPT_cpp = 423,                             /* -cpp */
  OPT_cpp_ = 424,                            /* -cpp= */
  OPT_d = 425,                               /* -d */
  OPT_dumpbase = 426,                        /* -dumpbase */
  OPT_dumpdir = 427,                         /* -dumpdir */
  OPT_dumpmachine = 428,                     /* -dumpmachine */
  OPT_dumpspecs = 429,                       /* -dumpspecs */
  OPT_dumpversion = 430,                     /* -dumpversion */
  OPT_e = 431,                               /* -e */
  /* OPT_encoding = 432, */                  /* -encoding */
  OPT_export_dynamic = 433,                  /* -export-dynamic */
  OPT_extdirs = 434,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 435, */               /* -fCLASSPATH= */
  OPT_fPIC = 436,                            /* -fPIC */
  OPT_fPIE = 437,                            /* -fPIE */
  OPT_fRTS_ = 438,                           /* -fRTS= */
  OPT_fabi_version_ = 439,                   /* -fabi-version= */
  OPT_faccess_control = 440,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 441,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 442,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 443,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 444,                  /* -falign-commons */
  OPT_falign_functions = 445,                /* -falign-functions */
  OPT_falign_functions_ = 446,               /* -falign-functions= */
  OPT_falign_jumps = 447,                    /* -falign-jumps */
  OPT_falign_jumps_ = 448,                   /* -falign-jumps= */
  OPT_falign_labels = 449,                   /* -falign-labels */
  OPT_falign_labels_ = 450,                  /* -falign-labels= */
  OPT_falign_loops = 451,                    /* -falign-loops */
  OPT_falign_loops_ = 452,                   /* -falign-loops= */
  OPT_fall_intrinsics = 453,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 454, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 455,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 456,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 457, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 458, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 459, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 460, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 461, */  /* -fargument-noalias-global */
  OPT_fasm = 462,                            /* -fasm */
  OPT_fassert = 463,                         /* -fassert */
  OPT_fassociative_math = 464,               /* -fassociative-math */
  OPT_fassume_compiled = 465,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 466,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 467,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 468,                   /* -fauto-inc-dec */
  OPT_fautomatic = 469,                      /* -fautomatic */
  OPT_faux_classpath = 470,                  /* -faux-classpath */
  OPT_fbackslash = 471,                      /* -fbackslash */
  OPT_fbacktrace = 472,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 473,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 474,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 475,              /* -fbootstrap-classes */
  OPT_fbounds_check = 476,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 477,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 478,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 479,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 480,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 481,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 482,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 483,                        /* -fbuiltin */
  OPT_fbuiltin_ = 484,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 485,                    /* -fcall-saved- */
  OPT_fcall_used_ = 486,                     /* -fcall-used- */
  OPT_fcaller_saves = 487,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 488,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 489,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 490,                /* -fcheck-data-deps */
  OPT_fcheck_new = 491,                      /* -fcheck-new */
  OPT_fcheck_references = 492,               /* -fcheck-references */
  OPT_fcheck_ = 493,                         /* -fcheck= */
  OPT_fclasspath_ = 494,                     /* -fclasspath= */
  OPT_fcoarray_ = 495,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 496,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 497,                         /* -fcommon */
  OPT_fcompare_debug = 498,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 499,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 500,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 501,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 502,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 503,                  /* -fcond-mismatch */
  OPT_fconserve_space = 504,                 /* -fconserve-space */
  OPT_fconserve_stack = 505,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 506,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 507,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 508,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 509,          /* -fconvert=little-endian */
  OPT_fconvert_native = 510,                 /* -fconvert=native */
  OPT_fconvert_swap = 511,                   /* -fconvert=swap */
  OPT_fcprop_registers = 512,                /* -fcprop-registers */
  OPT_fcray_pointer = 513,                   /* -fcray-pointer */
  OPT_fcrossjumping = 514,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 515,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 516, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 517,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 518,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 519,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 520,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 521,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 522,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 523,                       /* -fdbg-cnt= */
  OPT_fdce = 524,                            /* -fdce */
  OPT_fdebug_cpp = 525,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 526,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 527,            /* -fdebug-types-section */
  ...
  OPT_fdollar_ok = 545,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 546,         /* -fdollars-in-identifiers */
  OPT_fdse = 547,                            /* -fdse */
  OPT_fdump_ = 548,                          /* -fdump- */
  OPT_fdump_ada_spec = 549,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 550,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 551, */                /* -fdump-core */
  OPT_fdump_final_insns = 552,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 553,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 554,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 555,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 556,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 557,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 558,                /* -fdump-parse-tree */
  OPT_fdump_passes = 559,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 560,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 561,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 562,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 563,                 /* -fearly-inlining */
  OPT_felide_constructors = 564,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 565,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 566, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 567,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 568,        /* -femit-class-debug-always */
  OPT_femit_class_file = 569,                /* -femit-class-file */
  OPT_femit_class_files = 570,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 571,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 572,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 573,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 574,                        /* -fenable- */
  OPT_fenable_assertions = 575,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 576,             /* -fenable-assertions= */
  OPT_fencoding_ = 577,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 578,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 579, */           /* -fenum-int-equiv */
  OPT_fexceptions = 580,                     /* -fexceptions */
  OPT_fexcess_precision_ = 581,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 582,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 583,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 584,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 585,                       /* -fextdirs= */
  OPT_fextended_identifiers = 586,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 587,                /* -fextern-tls-init */
  OPT_fexternal_blas = 588,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 589, */       /* -fexternal-templates */
  OPT_ff2c = 590,                            /* -ff2c */
  OPT_ffast_math = 591,                      /* -ffast-math */
  OPT_ffat_lto_objects = 592,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 593,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 594,               /* -ffinite-math-only */
  OPT_ffixed_ = 595,                         /* -ffixed- */
  OPT_ffixed_form = 596,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 597,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 598,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 599,                    /* -ffloat-store */
  OPT_ffor_scope = 600,                      /* -ffor-scope */
  /* OPT_fforce_addr = 601, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 602,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 603,              /* -fforward-propagate */
  OPT_ffp_contract_ = 604,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 605,                      /* -ffpe-trap= */
  OPT_ffree_form = 606,                      /* -ffree-form */
  OPT_ffree_line_length_ = 607,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 608,          /* -ffree-line-length-none */
  OPT_ffreestanding = 609,                   /* -ffreestanding */
  OPT_ffriend_injection = 610,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 611,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 612,                   /* -ffunction-cse */
  OPT_ffunction_sections = 613,              /* -ffunction-sections */
  OPT_fgcse = 614,                           /* -fgcse */
  OPT_fgcse_after_reload = 615,              /* -fgcse-after-reload */
  OPT_fgcse_las = 616,                       /* -fgcse-las */
  OPT_fgcse_lm = 617,                        /* -fgcse-lm */
  OPT_fgcse_sm = 618,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 619,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 620,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 621,                         /* -fgnu-tm */
  OPT_fgnu_unique = 622,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 623,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 624,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 625,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 626,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 627,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 628,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 629,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 630,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 631,                       /* -fgraphite */
  OPT_fgraphite_identity = 632,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 633,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 634, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 635, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 636,           /* -fhash-synchronization */
  /* OPT_fhelp = 637, */                     /* -fhelp */
  /* OPT_fhelp_ = 638, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 639,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 640, */                /* -fhonor-std */
  OPT_fhosted = 641,                         /* -fhosted */
  /* OPT_fhuge_objects = 642, */             /* -fhuge-objects */
  OPT_fident = 643,                          /* -fident */
  OPT_fif_conversion = 644,                  /* -fif-conversion */
  OPT_fif_conversion2 = 645,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 646,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 647,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 648,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 649,             /* -fimplicit-templates */
  OPT_findirect_classes = 650,               /* -findirect-classes */
  OPT_findirect_dispatch = 651,              /* -findirect-dispatch */
  OPT_findirect_inlining = 652,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 653,         /* -finhibit-size-directive */
  OPT_finit_character_ = 654,                /* -finit-character= */
  OPT_finit_integer_ = 655,                  /* -finit-integer= */
  OPT_finit_local_zero = 656,                /* -finit-local-zero */
  OPT_finit_logical_ = 657,                  /* -finit-logical= */
  OPT_finit_real_ = 658,                     /* -finit-real= */
  OPT_finline = 659,                         /* -finline */
  OPT_finline_atomics = 660,                 /* -finline-atomics */
  OPT_finline_functions = 661,               /* -finline-functions */
  OPT_finline_functions_called_once = 662,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 663, */            /* -finline-limit- */
  OPT_finline_limit_ = 664,                  /* -finline-limit= */
  OPT_finline_small_functions = 665,         /* -finline-small-functions */
  OPT_finput_charset_ = 666,                 /* -finput-charset= */
  OPT_finstrument_functions = 667,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 668,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 669,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 670,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 671,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 672,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 673,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 674,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 675, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 676,                    /* -fipa-profile */
  OPT_fipa_pta = 677,                        /* -fipa-pta */
  OPT_fipa_pure_const = 678,                 /* -fipa-pure-const */
  OPT_fipa_reference = 679,                  /* -fipa-reference */
  OPT_fipa_sra = 680,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 681, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 682,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 683,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 684,              /* -fira-loop-pressure */
  OPT_fira_region_ = 685,                    /* -fira-region= */
  OPT_fira_share_save_slots = 686,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 687,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 688,                   /* -fira-verbose= */
  OPT_fivopts = 689,                         /* -fivopts */
  OPT_fjni = 690,                            /* -fjni */
  OPT_fjump_tables = 691,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 692,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 693,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 694,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 695, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 696,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 697,             /* -fleading-underscore */
  OPT_floop_block = 698,                     /* -floop-block */
  /* OPT_floop_flatten = 699, */             /* -floop-flatten */
  OPT_floop_interchange = 700,               /* -floop-interchange */
  OPT_floop_nest_optimize = 701,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 702, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 703,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 704,                /* -floop-strip-mine */
  OPT_flto = 705,                            /* -flto */
  OPT_flto_compression_level_ = 706,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 707,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 708,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 709,              /* -flto-partition=max */
  OPT_flto_partition_none = 710,             /* -flto-partition=none */
  OPT_flto_report = 711,                     /* -flto-report */
  OPT_flto_ = 712,                           /* -flto= */
  OPT_fltrans = 713,                         /* -fltrans */
  OPT_fltrans_output_list_ = 714,            /* -fltrans-output-list= */
  OPT_fmain_ = 715,                          /* -fmain= */
  OPT_fmath_errno = 716,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 717,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 718,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 719,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 720,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 721,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 722,                     /* -fmem-report */
  OPT_fmem_report_wpa = 723,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 724,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 725,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 726,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 727,                /* -fmessage-length= */
  OPT_fmodule_private = 728,                 /* -fmodule-private */
  OPT_fmodulo_sched = 729,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 730,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 731,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 732,                  /* -fms-extensions */
  OPT_fmudflap = 733,                        /* -fmudflap */
  OPT_fmudflapir = 734,                      /* -fmudflapir */
  OPT_fmudflapth = 735,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 736, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 737, */                  /* -fnew-abi */
  OPT_fnext_runtime = 738,                   /* -fnext-runtime */
  OPT_fnil_receivers = 739,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 740, */       /* -fno-vect-cost-model */
  ...
  OPT_fopt_info = 756,                       /* -fopt-info */
  OPT_fopt_info_ = 757,                      /* -fopt-info- */
  OPT_foptimize_register_move = 758,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 759,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 760,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 761,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 762, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 763,              /* -foutput-class-dir= */
  OPT_fpack_derived = 764,                   /* -fpack-derived */
  OPT_fpack_struct = 765,                    /* -fpack-struct */
  OPT_fpack_struct_ = 766,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 767,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 768,              /* -fpcc-struct-return */
  OPT_fpch_deps = 769,                       /* -fpch-deps */
  OPT_fpch_preprocess = 770,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 771,                     /* -fpeel-loops */
  OPT_fpeephole = 772,                       /* -fpeephole */
  OPT_fpeephole2 = 773,                      /* -fpeephole2 */
  OPT_fpermissive = 774,                     /* -fpermissive */
  OPT_fpic = 775,                            /* -fpic */
  OPT_fpie = 776,                            /* -fpie */
  OPT_fplan9_extensions = 777,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 778,                    /* -fplugin-arg- */
  OPT_fplugin_ = 779,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 780,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 781,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 782,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 783,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 784,                   /* -fpreprocessed */
  OPT_fpretty_templates = 785,               /* -fpretty-templates */
  OPT_fprofile = 786,                        /* -fprofile */
  OPT_fprofile_arcs = 787,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 788,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 789,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 790,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 791,              /* -fprofile-generate= */
  OPT_fprofile_report = 792,                 /* -fprofile-report */
  OPT_fprofile_use = 793,                    /* -fprofile-use */
  OPT_fprofile_use_ = 794,                   /* -fprofile-use= */
  OPT_fprofile_values = 795,                 /* -fprofile-values */
  OPT_fprotect_parens = 796,                 /* -fprotect-parens */
  OPT_frandom_seed = 797,                    /* -frandom-seed */
  OPT_frandom_seed_ = 798,                   /* -frandom-seed= */
  OPT_frange_check = 799,                    /* -frange-check */
  OPT_freal_4_real_10 = 800,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 801,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 802,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 803,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 804,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 805,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 806,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 807,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 808,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 809,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 810,                /* -frecord-marker=8 */
  OPT_frecursive = 811,                      /* -frecursive */
  OPT_freduced_reflection = 812,             /* -freduced-reflection */
  OPT_free = 813,                            /* -free */
  OPT_freg_struct_return = 814,              /* -freg-struct-return */
  OPT_fregmove = 815,                        /* -fregmove */
  OPT_frename_registers = 816,               /* -frename-registers */
  OPT_freorder_blocks = 817,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 818,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 819,              /* -freorder-functions */
  OPT_frepack_arrays = 820,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 821,           /* -freplace-objc-classes */
  OPT_frepo = 822,                           /* -frepo */
  OPT_frequire_return_statement = 823,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 824,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 825, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 826,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 827,                    /* -fresolution= */
  OPT_frounding_math = 828,                  /* -frounding-math */
  OPT_frtti = 829,                           /* -frtti */
  OPT_fsanitize_address = 830,               /* -fsanitize=address */
  OPT_fsanitize_thread = 831,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 832,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 833,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 834,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 835,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 836,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 837,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 838,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 839,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 840,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 841,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 842,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 843,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 844,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 845,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 846,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 847,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 848,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 849,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 850, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 851,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 852,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 853,              /* -fsecond-underscore */
  OPT_fsection_anchors = 854,                /* -fsection-anchors */
  /* OPT_fsee = 855, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 856,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 857,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 858, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 859,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 860,          /* -fselective-scheduling2 */
  OPT_fshort_double = 861,                   /* -fshort-double */
  OPT_fshort_enums = 862,                    /* -fshort-enums */
  OPT_fshort_wchar = 863,                    /* -fshort-wchar */
  OPT_fshow_column = 864,                    /* -fshow-column */
  OPT_fshrink_wrap = 865,                    /* -fshrink-wrap */
  OPT_fsign_zero = 866,                      /* -fsign-zero */
  OPT_fsignaling_nans = 867,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 868,               /* -fsigned-bitfields */
  OPT_fsigned_char = 869,                    /* -fsigned-char */
  OPT_fsigned_zeros = 870,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 871,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 872,               /* -fsource-filename= */
  OPT_fsource_ = 873,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 874,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 875,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 876,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 877, */                 /* -fsquangle */
  OPT_fstack_arrays = 878,                   /* -fstack-arrays */
  /* OPT_fstack_check = 879, */              /* -fstack-check */
  OPT_fstack_check_ = 880,                   /* -fstack-check= */
  OPT_fstack_limit = 881,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 882,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 883,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 884,                /* -fstack-protector */
  OPT_fstack_protector_all = 885,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 886,         /* -fstack-protector-strong */
  ...
  OPT_fvar_tracking = 979,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 980,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 981,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 982,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 983, /* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 984, */          /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 985,               /* -fvect-cost-model= */
  ...
  OPT_fworking_directory = 999,              /* -fworking-directory */
  OPT_fwpa = 1000,                           /* -fwpa */
  OPT_fwrapv = 1001,                         /* -fwrapv */
  /* OPT_fxref = 1002, */                    /* -fxref */
  /* OPT_fzee = 1003, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1004,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1005,                     /* -fzero-link */
  OPT_g = 1006,                              /* -g */
  OPT_gant = 1007,                           /* -gant */
  OPT_gcoff = 1008,                          /* -gcoff */
  OPT_gdwarf_ = 1009,                        /* -gdwarf- */
  OPT_gen_decls = 1010,                      /* -gen-decls */
  OPT_ggdb = 1011,                           /* -ggdb */
  OPT_gnat = 1012,                           /* -gnat */
  OPT_gnatO = 1013,                          /* -gnatO */
  OPT_gno_pubnames = 1014,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1015,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1016,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1017,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1018,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1019,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1020,                   /* -gsplit-dwarf */
  OPT_gstabs = 1021,                         /* -gstabs */
  OPT_gstabs_ = 1022,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1023,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1024,                        /* -gtoggle */
  OPT_gvms = 1025,                           /* -gvms */
  OPT_gxcoff = 1026,                         /* -gxcoff */
  OPT_gxcoff_ = 1027,                        /* -gxcoff+ */
  OPT_h = 1028,                              /* -h */
  OPT_idirafter = 1029,                      /* -idirafter */
  OPT_imacros = 1030,                        /* -imacros */
  OPT_imultiarch = 1031,                     /* -imultiarch */
  OPT_imultilib = 1032,                      /* -imultilib */
  OPT_include = 1033,                        /* -include */
  OPT_iplugindir_ = 1034,                    /* -iplugindir= */
  OPT_iprefix = 1035,                        /* -iprefix */
  OPT_iquote = 1036,                         /* -iquote */
  OPT_isysroot = 1037,                       /* -isysroot */
  OPT_isystem = 1038,                        /* -isystem */
  OPT_iwithprefix = 1039,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1040,              /* -iwithprefixbefore */
  OPT_k8 = 1041,                             /* -k8 */
  OPT_l = 1042,                              /* -l */
  OPT_lang_asm = 1043,                       /* -lang-asm */
  OPT_mabi_ = 1044,                          /* -mabi= */
  OPT_mabicalls = 1045,                      /* -mabicalls */
  OPT_mandroid = 1046,                       /* -mandroid */
  OPT_march_ = 1047,                         /* -march= */
  OPT_mbionic = 1048,                        /* -mbionic */
  OPT_mbranch_cost_ = 1049,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1050,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1051,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1052,                /* -mcode-readable= */
  OPT_mdebug = 1053,                         /* -mdebug */
  OPT_mdebugd = 1054,                        /* -mdebugd */
  OPT_mdivide_breaks = 1055,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1056,                  /* -mdivide-traps */
  OPT_mdmx = 1057,                           /* -mdmx */
  OPT_mdouble_float = 1058,                  /* -mdouble-float */
  OPT_mdsp = 1059,                           /* -mdsp */
  OPT_mdspr2 = 1060,                         /* -mdspr2 */
  OPT_meb = 1061,                            /* -meb */
  OPT_mel = 1062,                            /* -mel */
  OPT_membedded_data = 1063,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1064,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1065,                  /* -mextern-sdata */
  OPT_mfix_24k = 1066,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1067,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1068,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1069,                     /* -mfix-r4400 */
  OPT_mfix_sb1 = 1070,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1071,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1072,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1073,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1074,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1075,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1076,                 /* -mfp-exceptions */
  OPT_mfp32 = 1077,                          /* -mfp32 */
  OPT_mfp64 = 1078,                          /* -mfp64 */
  OPT_mfused_madd = 1079,                    /* -mfused-madd */
  OPT_mglibc = 1080,                         /* -mglibc */
  OPT_mgp32 = 1081,                          /* -mgp32 */
  OPT_mgp64 = 1082,                          /* -mgp64 */
  OPT_mgpopt = 1083,                         /* -mgpopt */
  OPT_mhard_float = 1084,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1085,              /* -minterlink-mips16 */
  OPT_mips = 1086,                           /* -mips */
  OPT_mips16 = 1087,                         /* -mips16 */
  OPT_mips3d = 1088,                         /* -mips3d */
  OPT_mllsc = 1089,                          /* -mllsc */
  OPT_mlocal_sdata = 1090,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1091,                    /* -mlong-calls */
  OPT_mlong32 = 1092,                        /* -mlong32 */
  OPT_mlong64 = 1093,                        /* -mlong64 */
  OPT_mmad = 1094,                           /* -mmad */
  OPT_mmcount_ra_address = 1095,             /* -mmcount-ra-address */
  OPT_mmcu = 1096,                           /* -mmcu */
  OPT_mmemcpy = 1097,                        /* -mmemcpy */
  OPT_mmt = 1098,                            /* -mmt */
  OPT_mno_float = 1099,                      /* -mno-float */
  OPT_mno_flush_func = 1100,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1101,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1102,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1103,                     /* -mno-mips3d */
  OPT_mpaired_single = 1104,                 /* -mpaired-single */
  OPT_mplt = 1105,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1106,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1107,               /* -mrelax-pic-calls */
  OPT_mshared = 1108,                        /* -mshared */
  OPT_msingle_float = 1109,                  /* -msingle-float */
  OPT_msmartmips = 1110,                     /* -msmartmips */
  OPT_msoft_float = 1111,                    /* -msoft-float */
  OPT_msplit_addresses = 1112,               /* -msplit-addresses */
  OPT_msym32 = 1113,                         /* -msym32 */
  OPT_msynci = 1114,                         /* -msynci */
  OPT_mtune_ = 1115,                         /* -mtune= */
  OPT_muclibc = 1116,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1117,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1118,                  /* -mvr4130-align */
  OPT_mxgot = 1119,                          /* -mxgot */
  OPT_n = 1120,                              /* -n */
  OPT_no_canonical_prefixes = 1121,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1122,              /* -no-integrated-cpp */
  OPT_noasmopt = 1123,                       /* -noasmopt */
  OPT_nocpp = 1124,                          /* -nocpp */
  OPT_nodefaultlibs = 1125,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1126,                   /* -nostartfiles */
  OPT_nostdinc = 1127,                       /* -nostdinc */
  OPT_nostdinc__ = 1128,                     /* -nostdinc++ */
  OPT_nostdlib = 1129,                       /* -nostdlib */
  OPT_o = 1130,                              /* -o */
  OPT_p = 1131,                              /* -p */
  OPT_pass_exit_codes = 1132,                /* -pass-exit-codes */
  /* OPT_pedantic = 1133, */                 /* -pedantic */
  OPT_pedantic_errors = 1134,                /* -pedantic-errors */
  OPT_pg = 1135,                             /* -pg */
  OPT_pie = 1136,                            /* -pie */
  OPT_pipe = 1137,                           /* -pipe */
  OPT_posix = 1138,                          /* -posix */
  OPT_print_file_name_ = 1139,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1140,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1141,          /* -print-multi-directory */
  OPT_print_multi_lib = 1142,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1143,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1144,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1145,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1146,               /* -print-prog-name= */
  OPT_print_search_dirs = 1147,              /* -print-search-dirs */
  OPT_print_sysroot = 1148,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1149,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1150,                        /* -profile */
  OPT_pthread = 1151,                        /* -pthread */
  OPT_quiet = 1152,                          /* -quiet */
  OPT_r = 1153,                              /* -r */
  OPT_rdynamic = 1154,                       /* -rdynamic */
  OPT_remap = 1155,                          /* -remap */
  OPT_s = 1156,                              /* -s */
  OPT_s_bc_abi = 1157,                       /* -s-bc-abi */
  OPT_save_temps = 1158,                     /* -save-temps */
  OPT_save_temps_ = 1159,                    /* -save-temps= */
  OPT_shared = 1160,                         /* -shared */
  OPT_shared_libgcc = 1161,                  /* -shared-libgcc */
  /* OPT_specs = 1162, */                    /* -specs */
  OPT_specs_ = 1163,                         /* -specs= */
  OPT_static = 1164,                         /* -static */
  OPT_static_libasan = 1165,                 /* -static-libasan */
  OPT_static_libgcc = 1166,                  /* -static-libgcc */
  OPT_static_libgcj = 1167,                  /* -static-libgcj */
  OPT_static_libgfortran = 1168,             /* -static-libgfortran */
  OPT_static_libgo = 1169,                   /* -static-libgo */
  OPT_static_libstdc__ = 1170,               /* -static-libstdc++ */
  OPT_static_libtsan = 1171,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1172, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1173, */                /* -std=c++0x */
  OPT_std_c__11 = 1174,                      /* -std=c++11 */
  OPT_std_c__1y = 1175,                      /* -std=c++1y */
  OPT_std_c__98 = 1176,                      /* -std=c++98 */
  OPT_std_c11 = 1177,                        /* -std=c11 */
  /* OPT_std_c1x = 1178, */                  /* -std=c1x */
  /* OPT_std_c89 = 1179, */                  /* -std=c89 */
  OPT_std_c90 = 1180,                        /* -std=c90 */
  OPT_std_c99 = 1181,                        /* -std=c99 */
  /* OPT_std_c9x = 1182, */                  /* -std=c9x */
  OPT_std_f2003 = 1183,                      /* -std=f2003 */
  OPT_std_f2008 = 1184,                      /* -std=f2008 */
  OPT_std_f2008ts = 1185,                    /* -std=f2008ts */
  OPT_std_f95 = 1186,                        /* -std=f95 */
  OPT_std_gnu = 1187,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1188, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1189, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1190,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1191,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1192,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1193,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1194, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1195, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1196,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1197,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1198, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1199, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1200,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1201, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1202, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1203, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1204,                     /* -std=legacy */
  OPT_symbolic = 1205,                       /* -symbolic */
  OPT_t = 1206,                              /* -t */
  OPT_time = 1207,                           /* -time */
  OPT_time_ = 1208,                          /* -time= */
  OPT_tno_android_cc = 1209,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1210,                 /* -tno-android-ld */
  OPT_traditional = 1211,                    /* -traditional */
  OPT_traditional_cpp = 1212,                /* -traditional-cpp */
  OPT_trigraphs = 1213,                      /* -trigraphs */
  OPT_u = 1214,                              /* -u */
  OPT_undef = 1215,                          /* -undef */
  OPT_v = 1216,                              /* -v */
  OPT_version = 1217,                        /* -version */
  OPT_w = 1218,                              /* -w */
  OPT_wrapper = 1219,                        /* -wrapper */
  OPT_x = 1220,                              /* -x */
  OPT_z = 1221,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
