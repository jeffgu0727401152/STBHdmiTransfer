...
struct bcm_sched_response;
struct bcm_sched_response2;
...
typedef struct BEGL_SchedInterface
{
   ...
   BEGL_SchedStatus   (*QueueJob)(void *context, void *session, const struct bcm_sched_job *job, struct bcm_sched_response *response);
   BEGL_SchedStatus   (*QueueBinRender)(void *context, void *session, const struct bcm_sched_job *bin, const struct bcm_sched_job *render, struct bcm_sched_response2 *response);
