...
struct Matrix4 {
    ...
    Matrix4<T> UpdateTranslate(const Vector3<T>& v)
    {
        w.x = v.x; w.y = v.y; w.z = v.z;
        return *this;
    }
    Matrix4<T> UpdateTranslate(T x, T y, T z)
    {
        w.x = x; w.y = y; w.z = z;
        return *this;
    }
    Matrix4<T> UpdateScale(T s)
    {
        x.x = s;
        y.y = s;
        z.z = s;
    ...
    Matrix4<T> UpdateScale(T x, T y, T z)
    {
        x.x = x;
        y.y = y;
        z.z = z;
    ...
    Matrix4<T> UpdateRotate(T degrees)
    {
        T radians = degrees * 3.1415926535897932384626433832795f / 180.0f;
        T s = std::sin(radians);
        T c = std::cos(radians);
    ...
    Matrix4<T> UpdateRotate(T degrees, const vec3& axis)
    {
        T radians = degrees * 3.1415926535897932384626433832795f / 180.0f;
        T s = std::sin(radians);
        T c = std::cos(radians);
        ...
        x.y = (1 - c) * axis.x * axis.y - axis.z * s;
        x.z = (1 - c) * axis.x * axis.z + axis.y * s;
        y.x = (1 - c) * axis.x * axis.y + axis.z * s;
        y.y = c + (1 - c) * axis.y * axis.y;
        y.z = (1 - c) * axis.y * axis.z - axis.x * s;
        z.x = (1 - c) * axis.x * axis.z - axis.y * s;
        z.y = (1 - c) * axis.y * axis.z + axis.x * s;
