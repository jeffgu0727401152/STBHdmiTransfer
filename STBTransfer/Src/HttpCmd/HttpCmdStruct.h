...
// pip preview Command
#define HTTPCMD_REQ_PIPPREVIEW	14
#define HTTPCMD_RES_PIPPREVIEW	15
typedef struct tagHTTPCMDREQPIPPREVIEWCMD : public HTTPCMDHEADER
{
	RECT rcPipPosition;
	int nVideoUrlBufLength;
} HTTPCMDREQPIPPREVIEWCMD;
typedef struct tagHTTPCMDRESPIPPREVIEWCMD : public HTTPCMDHEADER
{
} HTTPCMDRESPIPPREVIEWCMD;
